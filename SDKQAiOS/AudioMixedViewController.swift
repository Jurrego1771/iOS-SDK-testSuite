//
//  AudioMixedViewController.swift
//  SDKQAiOS
//
//  Audio Mixed: mismo enfoque que Android AudioMixedActivity.
//  Selector dinámico entre Local, AOD Simple, Episode y Live (sin servicio).
//

import UIKit
import MediastreamPlatformSDKiOS

class AudioMixedViewController: UIViewController {

    private static let aodId = "696c625d32ce0ef08ca5ef9d"
    private static let liveId = "6994f6128e4ea871f11730b9"
