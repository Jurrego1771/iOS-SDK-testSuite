//
//  VideoMixedWithServiceViewController.swift
//  SDKQAiOS
//
//  Video Mixed con PiP: mismo que Video Mixed pero con PiP + Control Center.
//  Equivalente a Android VideoMixedWithServiceActivity (reproducción en servicio/notificación).
//

import UIKit
import MediastreamPlatformSDKiOS

class VideoMixedWithServiceViewController: UIViewController {

    private static let vodId = "685be889d76b0da57e68620e"
    private static let liveId = "5fd39e065d68477eaa1ccf5a"
    ...
    private func configForMode(_ index: Int) -> MediastreamPlayerConfig {
        ...
        // Con PiP + Control Center (equivalente a "with service" en Android)
